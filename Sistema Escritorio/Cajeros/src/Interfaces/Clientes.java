...
public class Clientes extends javax.swing.JInternalFrame {
    ...
    int idpedid;
    public Clientes(int idempleado,int idpedido) {
        initComponents();
        this.idpedid=idpedido;
        ResultSet consulta=bd.consultar("SELECT idclientes,nombre,direccion,telefono FROM clientes;");
        String[]nomcolumnas=new String[]{"ID","Nombre","Dirección","Teléfono"};
        ...
        jTable1.addMouseListener(new MouseAdapter() {
                public void mouseClicked(MouseEvent e) {
                    if (e.getClickCount() == 1) {
                        ...
                        bd.ejecutar("UPDATE pedidos SET clientes_idclientes='"+target.getValueAt(row, 0)+"' WHERE idpedidos='"+idpedid+"'");
                        JOptionPane.showMessageDialog(null,target.getValueAt(row, 1)+" elegido como cliente");  
                    }
                }
            });
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/add88.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pencil41.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cross108.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/left224.png"))); // NOI18N
