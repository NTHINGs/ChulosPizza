...
public class ModificarCliente extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        bd.ejecutar("UPDATE clientes SET nombre='"+nombre.getText()+"', direccion='Calle: "+calle.getText()+" "+numero.getText()+" Colonia: "+colonia.getText()+"', telefono='"+telefono.getText()+"' WHERE idclientes='"+idcliente+"';");
