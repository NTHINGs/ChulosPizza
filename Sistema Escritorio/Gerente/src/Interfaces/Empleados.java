...
public class Empleados extends javax.swing.JInternalFrame {
    ...
    public Empleados(int idempleado) {
        ...
        ResultSet consulta=bd.consultar("SELECT * FROM Empleados;");
        String[]nomcolumnas=new String[]{"ID","Nombre","Apellidos","Calle","Colonia","Numero","Telefono","Email","Usuario","Contraseña","PuestoID"};
        jTable1.setModel(bd.llenarTabla(11, nomcolumnas, consulta));
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Chulo's Pizza: Gerente - Empleados");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Empleado", "Nombre(s)", "Apellidos", "Calle", "Numero", "Colonia", "Telefono", "E-mail", "Puesto"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        AgregarEmpleado a = new AgregarEmpleado(idempleado);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            int id=Integer.parseInt(JOptionPane.showInputDialog("Ingresa el ID del empleado que deseas modificar"));
            ModificarEmpleado me = new ModificarEmpleado(id);
            GerentePrincipal.GerentePrinc.add(me);
            me.toFront();
            me.show();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            bd.ejecutar("DELETE FROM Empleados WHERE idEmpleados='"+id+"';");
            JOptionPane.showMessageDialog(null, "Empleado Eliminado de la base de datos");
        }catch(NumberFormatException e){
            JOptionPane.showMessageDialog(null,"Ingresa un id válido","ERROR",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        ResultSet consulta=bd.consultar("SELECT * FROM Empleados where idEmpleados='"+txtbuscar.getText()+"';");
        String[]nomcolumnas=new String[]{"ID","Nombre","Apellidos","Calle","Colonia","Numero","Telefono","Email","Usuario","Contraseña","PuestoID"};
        jTable1.setModel(bd.llenarTabla(11, nomcolumnas, consulta));
