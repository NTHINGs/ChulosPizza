...
public class Proveedores extends javax.swing.JInternalFrame {
    ...
    public Proveedores(int idempleado) {
        initComponents();
        this.idempleado=idempleado;
        ResultSet consulta=bd.consultar("SELECT * FROM proveedores;");
        String[]nomcolumnas=new String[]{"ID","Nombre","Direccion","Telefono"};
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Chulo's Pizza: Gerente - Proveedores");
        setToolTipText("");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaces/buildings5.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        GerentePrincipal.GerentePrinc.add(ap);
        ap.toFront();
        ap.show();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ModificarProveedor mp = new ModificarProveedor(id);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            int id=Integer.parseInt(JOptionPane.showInputDialog("Ingresa el ID del proveedor que deseas eliminar"));
            bd.ejecutar("DELETE FROM proveedores WHERE idproveedor='"+id+"';");
            JOptionPane.showMessageDialog(null, "El proveedor ha sido eliminado de la base de datos");
        }catch(NumberFormatException e){
            JOptionPane.showMessageDialog(null,"Ingresa un id válido","ERROR",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        ResultSet consulta=bd.consultar("SELECT * FROM proveedores where idproveedor="+txtbuscar.getText()+";");
        String[]nomcolumnas=new String[]{"ID","Nombre","Direccion","Telefono"};
        jTable1.setModel(bd.llenarTabla(4, nomcolumnas, consulta));
