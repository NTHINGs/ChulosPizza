 ...
 * @author Misael
 */
public class Pizzas extends javax.swing.JInternalFrame {
    ...
    public Pizzas() {
        ...
        ResultSet consulta=bd.consultar("SELECT * FROM pizzas;");
        String[]nomcolumnas=new String[]{"ID","Nombre","Precio","Foto"};
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Chulo's Pizza: Getente - Menu de Pizzas");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pizza", "Nombre", "Ingredientes", "Precio"
            }
        ));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaces/pizza3.png"))); // NOI18N
        jButton1.setText("Nueva Pizza");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaces/italian1.png"))); // NOI18N
        jButton2.setText("Modificar Pizza");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaces/knife20.png"))); // NOI18N
        jButton3.setText("Eliminar Pizza");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NuevaPizza np = new NuevaPizza();
        GerentePrincipal.GerentePrinc.add(np);
        np.toFront();
        np.show();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            int id=Integer.parseInt(JOptionPane.showInputDialog("Ingresa el ID del proveedor que deseas modificar"));
            ModificacionPizza mp = new ModificacionPizza(id);
            GerentePrincipal.GerentePrinc.add(mp);
            mp.toFront();
            mp.show();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        ResultSet consulta=bd.consultar("SELECT * FROM pizzas where idpizzas="+txtbuscar.getText()+";");
        String[]nomcolumnas=new String[]{"ID","Nombre","Precio","Foto"};
        jTable1.setModel(bd.llenarTabla(4, nomcolumnas, consulta));
