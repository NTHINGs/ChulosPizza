...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaces/Logo principal copy.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet consultaidempleado=bd.consultar("SELECT idEmpleados FROM Empleados WHERE usuario='"+txtuser.getText()+"' AND pass='"+txtcontraseña.getText()+"' AND puestos_idpuestos=3;");
        if(consultaidempleado.first()){
                int idempleado = consultaidempleado.getInt("idEmpleados");
                Inventarios g = new Inventarios(idempleado);
                g.setVisible(true);
                setVisible(false);
            }
            else{
